================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Borna_Print Project Overview
===============================================================================

The application wizard has created this Borna_Print application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Borna_Print application.
...
Borna_Print.h
    ...
    project specific headers and declares the CBorna_PrintApp application class.

Borna_Print.cpp
    This is the main application source file that contains the application
    class CBorna_PrintApp.
...
Borna_PrintDlg.h, Borna_PrintDlg.cpp - the dialog
    These files contain your CBorna_PrintDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Borna_Print.pch and a precompiled types file named StdAfx.obj.
